...
public static void main(String[] args) {
		...
		List<String> pai= musicPaiService.getPai44();
		...
		song1.setVoice(0).setInstrument(Instruments.Piano).setTempo(speed);
		song2.setVoice(1).setInstrument(Instruments.Acoustic_Bass).setTempo(speed);
		...
		//保存地址
		String saveurl="D://tsetMusic.mid";
		//保存
