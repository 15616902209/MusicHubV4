...
*  项目名：MusicHub
*  版本： 1.0
*  创建时间：2020年1月15日 下午6:10:53
*  类名：GenerateVerse.java
*  类说明：生成主题
*/
public class GenerateVerse {
	//歌曲大致流程{"前奏","主题","副歌前","副歌","重复前奏","副歌前","副歌","间奏","副歌","结尾"};
			...
			public GenerateVerse(String gechi,int yinyu,int speed)
			{
				this.gechi=gechi;
				this.yinyu=yinyu;
				this.speed=speed;
			...
			{
				//保存地址
				String saveurl="D://VerseMusic.mid";
				//保存
			...
			public Pattern[] getVerse() {
				return Verse;
			}



			public void setVerse(Pattern[] Verse) {
				this.Verse = Verse;
			}
