...
*  项目名：MusicHub
*  版本： 1.0
*  创建时间：2020年1月15日 下午6:07:43
*  类名：GenerateIntro.java
*  类说明：生成前奏
*/
public class GenerateIntro {
		...
		public GenerateIntro(String gechi,int yinyu,int speed)
		{
			this.gechi=gechi;
			this.yinyu=yinyu;
			this.speed=speed;
		...
		public void generateIntro()
		{
			...
			this.Intro=musicGenerate.getSongChina(this.gechi,this.yinyu);
		}
		...
		{
			//保存地址
			String saveurl="D://IntroMusic.mid";
			//保存
		...
		public Pattern[] getIntro() {
			return Intro;
		}



		public void setIntro(Pattern[] intro) {
			Intro = intro;
		}
