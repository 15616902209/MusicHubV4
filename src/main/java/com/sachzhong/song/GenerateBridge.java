...
*  项目名：MusicHub
*  版本： 1.0
*  创建时间：2020年1月15日 下午6:12:19
*  类名：GenerateBridge.java
*  类说明：间奏
*/
public class GenerateBridge {
	//歌曲大致流程{"前奏","主题","副歌前","副歌","重复前奏","副歌前","副歌","间奏","副歌","结尾"};
			...
			public GenerateBridge(String gechi,int yinyu,int speed)
			{
				this.gechi=gechi;
				this.yinyu=yinyu;
				this.speed=speed;
			...
			public void generateBridge()
			{
				...
				this.Bridge=musicGenerate.getSongChina(this.gechi,this.yinyu);
			}
			...
			{
				//保存地址
				String saveurl="D://BridgeMusic.mid";
				//保存
			...
			public Pattern[] getBridge() {
				return Bridge;
			}



			public void setBridge(Pattern[] Bridge) {
				this.Bridge = Bridge;
			}
