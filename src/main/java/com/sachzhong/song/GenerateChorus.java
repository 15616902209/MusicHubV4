...
*  项目名：MusicHub
*  版本： 1.0
*  创建时间：2020年1月15日 下午6:11:47
*  类名：GenerateChorus.java
*  类说明：生成副歌
*/
public class GenerateChorus {
	//歌曲大致流程{"前奏","主题","副歌前","副歌","重复前奏","副歌前","副歌","间奏","副歌","结尾"};
			...
			public GenerateChorus(String gechi,int yinyu,int speed)
			{
				this.gechi=gechi;
				this.yinyu=yinyu;
				this.speed=speed;
			...
			//生成副歌
			public void generateChorus()
			{
				MusicGenerateUtil musicGenerate = new MusicGenerateUtil();
				this.Chorus=musicGenerate.getSongChina(this.gechi,this.yinyu);
			}
			...
			{
				//保存地址
				String saveurl="D://ChorusMusic.mid";
				//保存
			...
			public Pattern[] getChorus() {
				return Chorus;
			}



			public void setChorus(Pattern[] Chorus) {
				this.Chorus = Chorus;
			}
